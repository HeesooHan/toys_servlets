            ...
            <form method="get" action="/poll/SurveyDone">
                ...
                <div class=" container mx-auto">
                    ...
                    ArrayList surveyList=(ArrayList)request.getAttribute("surveyList"); String compare="" ; for (int
                        ...
                        questions=(String) survey.get("QUESTIONS"); String questionsId=(String)
                        survey.get("QUESTIONS_ID"); String choice=(String) survey.get("CHOICE"); String
                        choiceId=(String) survey.get("CHOICE_ID"); if (!compare.equals(questionsId)) { 
                  %>
                        <p>
                            <%= questions %>
                        </p>
                        <label>
                            <input type="radio" name="<%= questionsId %>" value="<%= choiceId %>">
                            <%= choice %>
                            <%= choiceId %>
                        </label> 
                        <br>
                ...
                <div class="container bg-white fs-6 py-6 row mx-auto my-3">
                    <div class="text-center d-flex justify-content-center py-2">
                        <button type="reset" class=" btn btn-white mx-2 btn-outline-dark">초기화</button>
